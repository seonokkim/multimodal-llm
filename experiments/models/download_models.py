...
def main():
    ...
    parser.add_argument('--model', type=str, required=True, choices=MODEL_MAP.keys(), help='Model name (e.g., qwen2-vl, llava, llama-3)')
    parser.add_argument('--variation', type=str, required=True, help='Model variation (e.g., 7b, 8b)')
    ...
    download_model(args.model, args.variation, save_dir)
